...
import { fetchDetail } from '../redux/slices/product/productSlice';
                ...
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        <div class="relative mb-6 lg:mb-10 lg:h-2/4 ">
                            <img src={detail?.data?.images[0]?.url} alt=""
                                class="object-cover w-full h-[500px] "/>
                        </div>
                        <div class="flex-wrap hidden md:flex ">
                            {
                                detail?.data?.images?.map(img => (
                    ...
                    <div class="lg:pl-20">
                        <div class="mb-8 ">
                            ...
                            <p class="inline-block mb-8 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                <span>$ {detail?.data?.discount}</span>
                                <span
                                    class="text-base font-normal text-gray-500 line-through dark:text-gray-400">$ {detail?.data?.price}</span>
                            </p>
